...
| **Prepare** | 2–6   | Cut a topic branch, run verify, run the input-space and definition sweeps on the pending change, propose a commit split (**first stop point**), push, open the PR | as long as your verify takes |
