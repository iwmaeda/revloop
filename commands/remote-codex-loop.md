...
nothing acceptable. `procedures/rigor-levels.md` states the four levels, the round cap each supplies,
the sweeps each owes, and the sufficiency test that ends a run.
